...
jams = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#jams.login(qr=True)
jams.login(token='token')
jams.loginResult()
...
╚═════════════════════════
"""
Jams="uda936836a9869eb86ec8ab992a4e8979"
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : TEAM JAMS\nContact Me : 👉 line.me/ti/p/~jameshakim1",
    "comment2":"Auto Like ©By : TEAM JAMS\nContact Me : 👉 line.me/ti/p/~jameshakim1",
    "comment3":"Auto Like ©By : TEAM JAMS\nContact Me : 👉 line.me/ti/p/~jameshakim1",
    "comment4":"Auto Like ©By : TEAM JAMS\nContact Me : 👉 line.me/ti/p/~jameshakim1",
    "comment5":"Auto Like ©By : TEAM JAMS\nContact Me : 👉 line.me/ti/p/~jameshakim1",    
    "commentOn":True,
    "commentBlack":{},
    ...
    try:
        ...
        if op.type == 19:
          ...
          try:
            if op.param3 in Fmid: #Akun Utama Ke Kick
              ...
              jams.acceptGroupInvitationByTicket(op.param1,Ti)
              time.sleep(0.01)
	 ...
	 if wait["Ghost"] == True:
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Jams")
...
#		else:                    
		    ...
		    cl.sendText(msg.to,"Khusus Jams")
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"Lest Go Ready.......")
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
            ...
            elif msg.text in ["Jams1 gift","jams1 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["Jams2 gift","jams2 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["Jams3 gift","jams3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'ae3d9165-fab2-4e70-859b-c14a9d4137c4',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"Jams1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"Jams2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"Jams3 Hadiir  \(ˆ▿ˆ)/")
		...
		if msg.from_ in Creator:
            ...
            elif msg.text.lower() in ["bot","jams"]:
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
            ...
            elif "Jams1 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Jams1 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ki.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                       ...
                       for target in targets:
                            try:
                               ...
                               ki.sendText(msg.to, "Copied (^_^)")
                                ...
                                print e
            elif "Jams2 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Jams2 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kk.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "Jams3 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Jams3 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kc.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "Jams4 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Jams4 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kr.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                ...
                try:
                    ...
                    cl.sendImageWithURL(msg.to, Jams)
            ...
            elif "/jams" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/jams","Jams")
            ...
            elif "/Jams1" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/jams1","Jams1")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/jams2" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/jams2","Jams2")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/jams3" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/jams3","Jams3")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/jams4" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/jams4","Jams4")
                    if len(string.decode('utf-8')) <= 5000:
                        profile = cl.getProfile()
                        profile.displayName = string
                        kr.updateProfile(profile)
            ...
            elif msg.text in ["Jams1 acc invite"]:
                if msg.from_ in admin:
                    gid = ki.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["Jams2 acc invite"]:
                if msg.from_ in admin:
                    gid = kk.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["Jams3 acc invite"]:
                if msg.from_ in admin:
                    gid = kc.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["Jams4 acc invite"]:
                if msg.from_ in admin:
